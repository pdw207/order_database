class ProductTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product_type.save
        format.html { redirect_to @product_type, notice: 'Su artículo se ha creado con éxito.' }
  ...
  def update
    respond_to do |format|
      if @product_type.update(product_type_params)
        format.html { redirect_to @product_type, notice: 'El cambio ha sido guardado con éxito.' }
  ...
  private
    ...
    def product_type_params
      params.require(:product_type).permit(:nombre)
    end
end
