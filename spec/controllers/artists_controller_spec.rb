  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved artist as @artist" do
        ...
        post :create, {:artist => { "nombre" => "invalid value" }}, valid_session
        assigns(:artist).should be_a_new(Artist)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested artist" do
        ...
        Artist.any_instance.should_receive(:update).with({ "nombre" => "MyString" })
        put :update, {:id => artist.to_param, :artist => { "nombre" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the artist as @artist" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Artist.any_instance.stub(:save).and_return(false)
        put :update, {:id => artist.to_param, :artist => { "nombre" => "invalid value" }}, valid_session
        assigns(:artist).should eq(artist)
      end
