  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved buyer as @buyer" do
        ...
        post :create, {:buyer => { "company" => "invalid value" }}, valid_session
        assigns(:buyer).should be_a_new(Buyer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested buyer" do
        ...
        Buyer.any_instance.should_receive(:update).with({ "company" => "" })
        put :update, {:id => buyer.to_param, :buyer => { "company" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the buyer as @buyer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Buyer.any_instance.stub(:save).and_return(false)
        put :update, {:id => buyer.to_param, :buyer => { "company" => "invalid value" }}, valid_session
        assigns(:buyer).should eq(buyer)
      end
