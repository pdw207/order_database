...
describe CustomersController do
  ...
  let(:valid_attributes) { { "compania" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved customer as @customer" do
        ...
        post :create, {:customer => { "compania" => "invalid value" }}, valid_session
        assigns(:customer).should be_a_new(Customer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested customer" do
        ...
        Customer.any_instance.should_receive(:update).with({ "compania" => "MyString" })
        put :update, {:id => customer.to_param, :customer => { "compania" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the customer as @customer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Customer.any_instance.stub(:save).and_return(false)
        put :update, {:id => customer.to_param, :customer => { "compania" => "invalid value" }}, valid_session
        assigns(:customer).should eq(customer)
      end
