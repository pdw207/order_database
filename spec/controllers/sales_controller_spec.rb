  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sale as @sale" do
        ...
        post :create, {:sale => { "amount" => "invalid value" }}, valid_session
        assigns(:sale).should be_a_new(Sale)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sale" do
        ...
        Sale.any_instance.should_receive(:update).with({ "amount" => "9.99" })
        put :update, {:id => sale.to_param, :sale => { "amount" => "9.99" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sale as @sale" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sale.any_instance.stub(:save).and_return(false)
        put :update, {:id => sale.to_param, :sale => { "amount" => "invalid value" }}, valid_session
        assigns(:sale).should eq(sale)
      end
